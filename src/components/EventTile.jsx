    ...
    return (
        <div key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg p-6 border-t-4 border-teal-500 transition duration-300 ease-in-out">
            ...
            <div className="mt-5 flex justify-end">
                <button className="text-sm text-teal-600 hover:text-teal-800 font-medium py-2 px-4 rounded-lg hover:bg-teal-50 transition duration-300">View Details</button>
            </div>
        </div>
    )
}
